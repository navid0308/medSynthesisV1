...
def Generator_2D_slicesV2(t1_path, t2_path, batchsize,inputKey='T1',outputKey='T2'):
    ...
    while True:
        ...
        for t1_filename, t2_filename in zip(t1_filenames, t2_filenames):
            ...
            maxPercentSource, minPercentSource = np.percentile(sourcenp, [100, 0])
            ...
            if epoch < 10:
                ...
                eps = np.mean(matMaskOut) * 2
            else:
                eps = np.mean(matMaskOut)
